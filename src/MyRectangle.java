...
public class MyRectangle extends MyBoundedShape
{
    ...
    public MyRectangle( int x1, int y1, int x2, int y2, Color color1, Color color2, boolean isDashed, boolean hasGradient, boolean fillShape, int strokeWidth, int dashLength )
    {
